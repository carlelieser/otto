...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![ping_sidecar, close_capture_window])
        .setup(|app| {
...
fn start_sidecar(app: &AppHandle) -> tauri::Result<Supervisor> {
    ...
    let mut supervisor = Supervisor::new(sidecar_config(recordings));
...
fn sidecar_config(recordings: PathBuf) -> SidecarConfig {
